import { ContractRunner, ContractTransaction, Overrides, BigNumberish, Contract } from "ethers";
 ...
 * MME1155
 */
export interface MME1155 extends BaseContract {
...
export const getMME1155 = (provider: ContractRunner): MME1155 => {
  const contract = new Contract('0x72f2A9e83c31686b7803AA1b9B822521901DaEa4', abi, provider);
  return contract as any as MME1155;
}